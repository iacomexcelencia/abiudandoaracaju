...
export const aracajuOfficialSpots = [
  ...
  // 35. Mercado Municipal Antônio Franco
  {
  ...
  // 37. Complexo Histórico da Praça Fausto Cardoso
  {
  ...
  // 38. Parque Governador Antonio Carlos Valadares
  {
...
export default aracajuOfficialSpots;